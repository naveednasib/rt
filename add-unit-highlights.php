...
<body>
  ...
  <!--header-->
    ...
    <section class="datasets top-container">
        ...
        <form  action="php/add-unit-highlights.php" enctype="multipart/form-data" method="post">
                ...
                <tr>
                <td> add hightlights</td>
                    <td class="form-group">
                            <textarea rows="5" cols="15" class="form-control" type="text" name="unit_highlights"> 
                ...
                <td>add  bedrooms</td>
                    <td class="form-group">
                                  ...
                                  <textarea rows="5" cols="15" class="form-control" type="text" name="unit_bedrooms"> 
                ...
                <tr>
                    ...
                    <td colspan="2" class="form-group">
                            <input  type="submit" name="submit_map" class="btn btn-lg btn-success">                         
                    </td>
                </tr>
