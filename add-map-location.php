...
<body>
  ...
  <!--header-->
    ...
    <section class="datasets top-container">
        ...
        <form  action="php/add-map-location.php" enctype="multipart/form-data" method="post">
                ...
                <tr>
                <td>add  unit longitude</td>
                    <td class="form-group">
                            <input class="form-control" type="text" name="unit_longitude">
                    </td>
                </tr>

                  <tr>
                <td>add  unit latitude</td>
                    <td class="form-group">
                            <input class="form-control" type="text" name="unit_latitude">
                    </td>
                </tr>
