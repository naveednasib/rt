    ...
    .form-container      .select-option {padding:0 15px ;    height: 52px;}
     ...
     <?php 
       ...
       include_once('connection.php'); 
                ...
                $serach_input = $_POST['serach_input'];
              //  echo   $serach_input;
                $fetch_unit_detail ="SELECT * FROM tbl_unitdetail WHERE unit_name LIKE '%$serach_input%'  OR unit_location LIKE '%$serach_input%' OR unit_developerName LIKE  '%$serach_input%'";
                $unitresult = mysqli_query($conn, $fetch_unit_detail );
              
            
                 $count = $unitresult->num_rows;
...
<body>
    ...
    <section class="tile-container top-container">
       ...
       <?php    }                else{    ?>  
                        ...
                        <h2>
                     <?php echo  $count?> Result Found On Your Query 
                        </h2>
